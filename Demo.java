...
import iiitb.ess201a7.r16090.Fleet16090;
...
public class Demo {
	...
	public static void main(String[] args) {
		...
		{
			Fleet f1 = new Fleet16090("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);

			f1 = new Fleet16090("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);
		}
